...
const STEPS = [
  {
    ...
    color: '#3397FF',
    description:
      'We map your goals, users, and technical requirements to define scope, architecture, and success metrics.',
  },
  {
    step: '02',
    title: 'Design',
    color: '#5cb460',
    description:
      'Product flows, wireframes, and interfaces shaped around usability, clarity, and maintainable system design.',
  },
  {
    step: '03',
    title: 'Develop',
    color: '#ff9e1d',
    description:
      'Clean, testable code delivered in agile sprints—with CI/CD, code reviews, and transparent progress throughout.',
  },
  {
    step: '04',
    title: 'Deploy',
    color: '#ff3700',
    description:
      'Launch to production, monitor performance, and iterate— we stay with you to improve reliability and add value.',
  },
]
    ...
    >
      ...
      <Container maxWidth='lg' sx={{ position: 'relative', zIndex: 1 }}>
        <Box sx={{ textAlign: { xs: 'center', md: 'left' } }}>
          <HomeSectionHeader
            label='How We Work'
            title='From concept to production in four steps'
            description='A proven software delivery workflow that keeps stakeholders aligned, quality high, and releases on schedule.'
            align='center'
          />
        </Box>
